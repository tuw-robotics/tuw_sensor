...
public:
    ...
    char    ReadChar    (char *pByte, const unsigned int TimeOut_ms=static_cast<unsigned int>(NULL));  // cast from NULL to avoid compiler warning
    ...
    int     ReadString  (   char *String,
                            ...
                            const unsigned int TimeOut_ms=static_cast<unsigned int>(NULL));  // cast from NULL to avoid compiler warning
